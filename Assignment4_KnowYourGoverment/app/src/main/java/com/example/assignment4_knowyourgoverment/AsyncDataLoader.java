...
public class AsyncDataLoader extends AsyncTask<String, Void, String> {
    ...
    private String prefix = "https://www.googleapis.com/civicinfo/v2/representatives?key=AIzaSyA5zEK8zeBXLnhdaa9IZElyb-ZJiyYOmuo&address=";
        ...
        try {
            ...
            for (int i = 0; i<length; i++){
                ...
                for (int j = 0; j<indicesStr.length(); j++){
                    ...
                    Log.d("name", jOfficial.getString("name"));
                    ...
                    JSONObject jAddress = jAddresses.getJSONObject(0);
                        ...
                        official.setAddress("Not Available");
                    }
